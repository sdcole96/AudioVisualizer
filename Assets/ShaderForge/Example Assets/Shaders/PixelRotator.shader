...
/////// Diffuse:
                ...
                float node_563_ang = node_3458.g;
                ...
                float3 node_748 = (pow(float3(float2(node_737,node_739),node_741),0.0)*(1.0 - floor(saturate(length((float2(1,3)*node_563))))));
                float3 diffuseColor = node_748;
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
////// Emissive:
                float3 emissive = node_748;
/// Final Color:
...
/////// Diffuse:
                ...
                float2 node_741_rnd = 4.789*sin(489.123*(node_741_skew));
                float node_741 = frac(node_741_rnd.x*node_741_rnd.y*(1+node_741_skew.x));
                float4 node_6303 = _Time;
                float node_563_ang = node_6303.g;
                float node_563_spd = 1.0;
                float node_563_cos = cos(node_563_spd*node_563_ang);
                float node_563_sin = sin(node_563_spd*node_563_ang);
                float2 node_563_piv = float2(0,0);
