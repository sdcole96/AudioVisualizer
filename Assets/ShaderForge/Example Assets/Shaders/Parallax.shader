    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_110 = (0.5*(node_574.a - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
...
////// Specular:
                ...
                float3 diffuseColor = float3(node_577.r,node_577.r,node_577.r); // Need this for specular when using metallic
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,node_577.b);
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor * node_577.b,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 diffColor = float3(node_577.r,node_577.r,node_577.r);
                float specularMonochrome;
                float3 specColor;
