    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 normalLocal = lerp(float3(1,0,1),_Refraction_var.rgb,_RefractionIntensity);
